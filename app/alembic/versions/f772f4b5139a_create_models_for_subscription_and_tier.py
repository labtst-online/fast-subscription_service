...
def upgrade():
    ...
    sa.Column('status', postgresql.ENUM('ACTIVE', 'INACTIVE', 'PENDING', 'CANCELLED', name='subscriptionstatus'), nullable=True),
    sa.Column('started_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
    sa.Column('expires_at', postgresql.TIMESTAMP(timezone=True), server_default=sa.text('now()'), nullable=False),
